package com.shu.framework.views.collaborativemasterdetail;

import com.shu.framework.data.entity.SamplePerson;
import com.shu.framework.data.service.SamplePersonService;
...
@Route(value = "collaborative-master-detail/:samplePersonID?/:action?(edit)")
@AnonymousAllowed
@Uses(Icon.class)
