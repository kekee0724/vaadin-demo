package com.shu.framework.data.generator;

import com.shu.framework.data.Role;
import com.shu.framework.data.entity.SamplePerson;
import com.shu.framework.data.entity.User;
import com.shu.framework.data.service.SamplePersonRepository;
import com.shu.framework.data.service.UserRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 4, 5, 0, 0, 0));
