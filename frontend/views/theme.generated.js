...
import stylesCss from '../themes/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_views_componentCss']) {
    document['_vaadintheme_views_componentCss'] = true;
  }
  ...
  // injectGlobalCss(sizing.cssText, target, true);
  // injectGlobalCss(style.cssText, target, true);
  // injectGlobalCss(userColors.cssText, target, true);
};
